...
function Dashboard() {
  ...
  const quickActions = [
    ...
    {
      title: "Messages",
      description: "Chat directly with your trainer or trainees.",
      icon: "💬",
      path: "/chat",
    ...
    {
      title: "Video Call",
      description: "Start live virtual workout sessions with your trainer.",
      icon: "📹",
      path: "/video-call",
    ...
    },
    {
      ...
      description: "Compare your performance against the community.",
      icon: "📊",
